...
export function decideSnapshotUpdate(
  ...
  if ((currentSnapshot.room.gameType === "NUMBER_TILE" || currentSnapshot.room.gameType === "DRAW_RELAY" || currentSnapshot.room.gameType === "SNEAKY_LUNCH" || currentSnapshot.room.gameType === "WOLF_NIGHT" || currentSnapshot.room.gameType === "HALLI_GALLI" || currentSnapshot.room.gameType === "ISLAND_SETTLERS") &&
