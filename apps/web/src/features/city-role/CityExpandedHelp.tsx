...
export function CityExpandedHelp() {
  return <details className="city-catalog city-expanded-help"><summary>게임 방법 보기</summary>
    <div className="city-guide-sections">
      ...
      <section><h3>응답이 필요한 능력</h3><p>몰수·협박·역할 교환 등의 선택은 화면에 안내됩니다. 선택한 카드와 진짜 표식은 허용된 사람에게만 보입니다. 선택 시간은 45초, 행동 시간은 90초이며 응답 중에도 시간이 흐릅니다. 시간 초과 시 서버가 기본 선택으로 진행합니다.</p></section>
    </div>
  </details>;
}
