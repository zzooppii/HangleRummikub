...
export function projectHalli(game: HalliStoredGame) {
 ...
 return s.phase === "FINISHED" ? parse(HalliFinishedProjectionSchema, { ...base, phase: "FINISHED", result: s.result }) :
  parse(HalliPlayingProjectionSchema, { ...base, phase: "PLAYING", turnId: s.transitionId, activePlayerId: s.activePlayerId, flipAvailableAt: s.flipAvailableAt, deadlineAt: s.nextTransitionAt });
}
