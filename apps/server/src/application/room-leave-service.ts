    ...
    try {
      const result = await this.#dependencies.roomMutationExecutor.run(
        ...
        async () => {
          ...
          if ((candidate.gameType === "NUMBER_TILE" || candidate.gameType === "DRAW_RELAY" || candidate.gameType === "SNEAKY_LUNCH" || candidate.gameType === "WOLF_NIGHT" || candidate.gameType === "HALLI_GALLI" || candidate.gameType === "ISLAND_SETTLERS")) {
