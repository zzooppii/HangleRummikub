...
P19B checkpoint: `1958dfc`, typecheck/build PASS, 1629 tests. P19C now adds exact Room/projection/command branches, private draft commits, one stage deadline, concrete recovery adapter, leave/resume and the approved Host policy. Raw 3/4/8-player chains reach Reveal/Finished/rematch. Original prompt dataset contains 600 unique words (200/250/150). P19C gate: 1637 tests (shared110/Web409/server1118), zero failures/skips; typecheck/build PASS, existing large-chunk warning retained. Web capability/catalog stay at four games until P19D. No Railway deployment.
